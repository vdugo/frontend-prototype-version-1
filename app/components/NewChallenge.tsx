...
export default function NewChallenge({ onSubmit, challenge }: { onSubmit: (code: string, output: string) => void, challenge: string }) {
  ...
  return (
    <div className="w-full space-y-4">
      ...
      <p className="text-lg">Solve this challenge without AI assistance:</p>
